...
<div class="row">
    <div class="col-sm-12 col-md-3">
        ...
        echo $form->dropDownListGroup($model,'id_bloque',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5'), 'data'=>array('0'=>'Seleccione...')+$data), 'labelOptions'=>array('label'=>'Bloque:'))); ?>
    </div>
    <div class="col-sm-12 col-md-3">
        ...
        echo $form->dropDownListGroup($model,'id_tipo_categoria',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5'), 'data'=>array('0'=>'Seleccione...')+$data), 'labelOptions'=>array('label'=>'Tipo de Categoría:'))); ?>
    </div>
    <div class="col-sm-12 col-md-3">
...
<div class="panel panel-default">
  <div class="panel-heading"><span class="glyphicon glyphicon-indent-right" aria-hidden="true"></span>&nbsp;&nbsp;Items de Calificación</div>
    <div class="pd-inner">
            <div id="table-participante" style="padding: 0 20px 20px 20px;">
                <div class="row" id="head-table-participante">
                  <div class="col-xs-3" style="padding: 8px;"><center><strong>Items</strong></center></div>
                  <div class="col-xs-3" style="padding: 8px;"><center><strong>Rango minimo</strong></center></div>
                  <div class="col-xs-3" style="padding: 8px;"><center><strong>Rango máximo</strong></center></div>
                  <div class="col-xs-3" style="padding: 8px;"><strong>Acción</strong></div>
                </div>
                <?php
                $count = 0;
