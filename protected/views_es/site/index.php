...
$this->menu=array(
array('label'=>'Mi perfil','url'=>array('/usuario/'.Yii::app()->user->id_usuario_sistema)),
array('label'=>'Competencia','url'=>array('/competencia/index')),
array('label'=>'Historial','url'=>array('/usuario/historial')),
                    ...
                    <div class="col-sm-12 bootstrap-timepicker input-group">
                        <?php
                            if($competencia->gratis != 1){
                                ...
                                echo "<center><h5>Competencia Gratuita</h5><br></center>";
                            }
                        ?>
                    </div>
...
<!--                    <button style=" width: 100%;" type="button" class="btn btn-default">
                        Comprar pase de competidor &nbsp; &nbsp; <span class="glyphicon glyphicon-question-sign"></span>
                    </button>
...
<div class="panel panel-default">
  <div class="panel-heading">Leyenda</div>
  <div class="panel-body">
    <div class="row">
        ...
        <div class="col-sm-12 col-md-3">
            ...
            <center>
                Haz realizado el pago correctamente
            </center>
        </div>
        <div class="col-sm-12 col-md-3">
            <span  class="input-group-addon">
            ...
            <center>
                Se ha presentado un problema con su pago
            </center>
        </div>
    </div>
  </div>
