    ...
    <div id="RU">     
          ...
          <div class="row">
            <div class="col-md-3">
              ...
              echo $form->dropDownListGroup($usuario,'tipo_documento',array('widgetOptions'=>array('htmlOptions'=>array('name'=>'tipo_documento', 'class'=>'span5'),'data'=>array(''=>'Select...')+$data), 'labelOptions'=>array('label'=>'Identification:')));
              ?>
            </div>
            <div class="col-md-9">
              <?php echo $form->textFieldGroup($usuario,'cedula',array('widgetOptions'=>array('htmlOptions'=>array('name'=>'identificacion', 'class'=>'span5', 'onblur'=>'findIdentificacion(this.value)' , 'onKeyPress'=>'return soloNumeros(event)', 'maxlength'=>15)))); ?>
            </div>
          </div>  
          <div class="row">
            <div class="col-md-12">
