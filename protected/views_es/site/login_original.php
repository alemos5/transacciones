...
<table>
    <tr><td><input type="hidden" name="on0" value="monto">monto</td></tr><tr><td><input type="text" value="300" name="os0" maxlength="200"></td></tr>
</table>
...
<div class="row">
  ...
  <div class="form">
    ...
    <p><?php echo $form->textFieldGroup($model,'username', array('widgetOptions'=>array('htmlOptions'=>array('placeholder'=>'Coloca tu correo.')),'append' => '<i class="glyphicon glyphicon-user"></i>')); ?></p>
    <p><?php echo $form->passwordFieldGroup($model,'password', array('widgetOptions'=>array('htmlOptions'=>array('placeholder'=>'Coloca tu contraseña.')),'append' => '<i class="glyphicon glyphicon-lock"></i>')); ?></p>
    ...
    <label style="width: 100%;" data-target="#recuperarClaveUsuario" data-toggle="modal" class="btn">¿Olvidaste tu contraseña?</label>
            ...
            <center>
                <div id="cedulaBusqueda_form" class="col-md-12">
                    ...
                    <div id="errorRecuperacion2" style="display: none;" class="alert alert-danger">
                        ...
                        <label id="correoRM" style="display: none;">El correo ingresado no presenta una forma correcta <b>(usuario@dominio.com)</b></label>
                        <label id="correoRE" style="display: none;">El correo ingresado no existe en nuestra base de dato, porfavor regístrese</label>
                    </div>
                    
                    <div id="okRecuperar">
                        <div class="form-group">
                            <div  class="col-sm-10 bootstrap-timepicker input-group">
                                <input  size="35" id="correoBusqueda" class="form-control" type="text" maxlength="30" name="correoBusqueda" placeholder="Ingrese su correo" onblur="correoForma(this.value)" >
                                <label onclick="claveCorreo()" class="input-group-addon btn btn-primary" style="width: 10%;"><span class="glyphicon glyphicon-send" aria-hidden="true"></span>&nbsp;&nbsp;Enviar Correo</label>
                            </div>    
                        </div>
                    </div>
                </div>
...
//                array('label'=>'Contrato', 'view' =>'_contrato', 'data'=>array('usuario'=>$usuario)),
                array('itemOptions' => array('id' => 'registroUsuario'),'label'=>'Registro de Usuario', 'view' =>'_registroUsuario', 'data'=>array('usuario'=>$usuario)),
              ),
            ));
            ?> 
        </div>
