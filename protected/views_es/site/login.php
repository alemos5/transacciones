...
<div class="row">
  ...
  <div class="form">
    ...
    <div class="alert alert-warning"><i class="glyphicon glyphicon-info-sign"></i> Fields with * are required.</div>
    <p><?php echo $form->textFieldGroup($model,'username', array('widgetOptions'=>array('htmlOptions'=>array('placeholder'=>'Type your email.')),'append' => '<i class="glyphicon glyphicon-user"></i>')); ?></p>
    <p><?php echo $form->passwordFieldGroup($model,'password', array('widgetOptions'=>array('htmlOptions'=>array('placeholder'=>'Type your password.')),'append' => '<i class="glyphicon glyphicon-lock"></i>')); ?></p>
    <div class="row"><div class="col-sm-3 control-label"></div><div class="col-sm-9">
        <?php $this->widget('CCaptcha', array('clickableImage'=>1)); ?>
        </div></div>
    <p><?php echo $form->textFieldGroup($model,'verifyCode',array('widgetOptions'=>array('htmlOptions'=>array('id'=>'input-lg', 'placeholder'=>'Type what you see on the image')), 'append' => '<i class="glyphicon glyphicon-barcode"></i>')); ?></p>
    ...
    <!--</div>-->  
    <hr>  
    <button id="yw1" style="width: 100%; margin-bottom: 5px; " class="btn btn-lg btn-primary" name="yt0" type="submit">Log In</button>    
    <label style="width: 100%;" data-target="#recuperarClaveUsuario" data-toggle="modal" class="btn">Forgot your password?</label>
            ...
            <center>
                <div id="cedulaBusqueda_form" class="col-md-12">
                    ...
                    <div id="errorRecuperacion2" style="display: none;" class="alert alert-danger">
                        ...
                        <label id="correoRM" style="display: none;">Invalid Email <b>(user@domain.com)</b></label>
                        <label id="correoRE" style="display: none;">We dont recognize that email, please sign up</label>
                    </div>
                    
                    <div id="okRecuperar">
                        <div class="form-group">
                            <div  class="col-sm-10 bootstrap-timepicker input-group">
                                <input  size="35" id="correoBusqueda" class="form-control" type="text" maxlength="30" name="correoBusqueda" placeholder="Your email" onblur="correoForma(this.value)" >
...
//                array('label'=>'Contrato', 'view' =>'_contrato', 'data'=>array('usuario'=>$usuario)),
                array('itemOptions' => array('id' => 'registroUsuario'),'label'=>'User Sign Up', 'view' =>'_registroUsuario', 'data'=>array('usuario'=>$usuario)),
              ),
            ));
            ?> 
        </div>
