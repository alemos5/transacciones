...
<div class="row">
    <div class="col-sm-4 col-md-4">
        ...
        <?php echo $form->dropDownListGroup($model, 'tipo_documento', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5'), 'data' => array('' => 'Seleccione...', '1' => 'Venezolano', '2' => 'Extranjero')), 'labelOptions' => array('label' => 'Nacionalidad'))); ?> 
    </div>
    <div class="col-sm-4 col-md-4">
...
<?php //echo $form->textFieldGroup($model,'rif',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5','maxlength'=>10)), 'labelOptions'=>array('label'=>'Registro Información Fiscal (RIF):')));  ?>
        ...
        echo $form->dropDownList($model, 'rif', array('' => 'Seleccione...') + $data, array('id' => 'select_Socio_rif', 'name' => 'select_Socio_rif', 'class' => 'span5 form-control', 'style' => 'width: 20%;display: inline-table;'));
        ?>
...
<?php echo $form->datePickerGroup($model, 'fecha_nacimiento', array('widgetOptions' => array('options' => array('format' => 'dd-mm-yyyy'), 'htmlOptions' => array('class' => 'span5')), 'labelOptions' => array('label' => 'Fecha de Nacimiento:'), 'prepend' => '<i class="glyphicon glyphicon-calendar"></i>')); ?>
    </div>
    <div class="col-sm-4 col-md-4">
        <?php // echo $form->textFieldGroup($model,'sexo',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5','maxlength'=>1))));  ?>
        <?php echo $form->dropDownListGroup($model, 'sexo', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5'), 'data' => array('' => 'Seleccione...', '1' => 'Femenino', '2' => 'Masculino')), 'labelOptions' => array('label' => 'Sexo'))); ?> 
    </div>
</div>
...
<div class="row">
    <div class="col-sm-3 col-md-3">
        ...
        echo $form->dropDownListGroup($model,'id_estado',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5', 'onchange'=>'findMunicipio(this.value)'), 'data'=>array(''=>'Seleccione...')+$data), 'labelOptions'=>array('label'=>'Estado:'))); ?>
    </div>
    <div class="col-sm-3 col-md-3">
        ...
        echo $form->dropDownListGroup($model,'id_municipio',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5', 'onchange'=>'findParroquia(this.value)'), 'data'=>array(''=>'Seleccione...')+$data), 'labelOptions'=>array('label'=>'Municipio:'))); ?>
    </div>
    <div class="col-sm-3 col-md-3">
        ...
        echo $form->dropDownListGroup($model,'id_parroquia',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5'), 'data'=>array(''=>'Seleccione...')+$data), 'labelOptions'=>array('label'=>'Parroquia:'))); ?>
    </div>
    <div class="col-sm-3 col-md-3">
