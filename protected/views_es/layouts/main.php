    ...
    array(
        ...
        'items' => array(
            ...
            array(
                ...
                'items' => array(
//                    array('label' => '<span class="glyphicon glyphicon-shopping-cart"></span>', 'url' => '#','items'=> array(
					...
					<?php
					  ...
					  $this->widget('booster.widgets.TbMenu', array(
						...
						'htmlOptions' => array('class' => 'aside'),
                                            ...
                                            $this->menu =array(
                                            array('label'=>'Mi perfil','url'=>array('/usuario/update/'.Yii::app()->user->id_usuario_sistema)),
                                            array('label'=>'Competencia','url'=>array('/site/index')),
...
<?php echo $content; ?>
    ...
    <?php if(!Yii::app()->user->isGuest):
		...
		echo '<div  id="footer">
				<hr class="soften">
				WIN - Online Competition System<br />
