...
<span class="ez"><?php echo __('Dj'); ?></span>
...
<div class="pd-inner">
    ...
    <button onclick="comprimir()" type="button" class="btn btn-primary">
        <?php echo __('Compress music'); ?>
    </button>
    <div class="pull-right "  >
        <div id="resultadoAudio"></div>
    </div>
                            ...
                            <tbody>
                                ...
                                foreach ($competencias as $competencia){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                            <a href="ronda?idc=<?php echo $competencia->id_copetencia; ?>">
...
<script>
function comprimir(){    
    $.post("<?php echo Yii::app()->createUrl('dj/comprimirAudio') ?>",{ },
    function(data){
        $('#resultadoAudio').html(data);
    });
}
</script>