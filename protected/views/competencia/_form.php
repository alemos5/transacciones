...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <h3 class="panel-title" style="display: inline;"><?php echo __('Competitor pass'); ?></h3>
        ...
        <div class="pd-inner">
            <div id="table-participante" style="padding: 0 20px 20px 20px;">
                ...
                <div class="row" id="head-table-participante">
                  <div class="col-xs-4" style="padding: 8px;"><center><strong><?php echo __('Date'); ?></strong></center></div>
                  <div class="col-xs-4" style="padding: 8px;"><center><strong><?php echo __('Value'); ?></strong></center></div>
                  <div class="col-xs-4" style="padding: 8px;"><strong><?php echo __('Action'); ?></strong></div>
                </div>
...
//                                    echo $form->datePickerGroup($paseCompetidor, 'fecha_pase', array('widgetOptions' => array('options' => array('format' => 'dd-mm-yyyy'), 'htmlOptions' => array('class' => 'span5', 'name'=>'datepicker_'.$i, 'disabled'=>'disabled')), 'labelOptions' => array('label' => false), 'prepend' => '<i class="glyphicon glyphicon-calendar"></i>')); 
                                ...
                                <div class="col-xs-1" style="padding: 8px;">
                                    <?php 
                                        ...
                                        echo $form->dropDownListGroup($paseCompetidor,'dia',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5', 'name'=>'diaPase'.$ii),'data'=>array(''=>'Select...')+$data),  'labelOptions'=>array('label'=>false)));
                                    ?>
                                </div>
                                <div class="col-xs-1" style="padding: 8px;">
                                    <?php 
                                        ...
                                        echo $form->dropDownListGroup($paseCompetidor,'mes',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5', 'name'=>'mesPase'.$ii),'data'=>array(''=>'Select...')+$data),  'labelOptions'=>array('label'=>false)));
                                    ?>
                                </div>
                                <div class="col-xs-2" style="padding: 8px;">
                                    <?php 
                                        ...
                                        echo $form->dropDownListGroup($paseCompetidor,'anio',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5', 'name'=>'anioPase'.$ii),'data'=>array(''=>'Select...')+$data),  'labelOptions'=>array('label'=>false)));
                                    ?>
                                </div>
        ...
        //            echo CHtml::beginForm('/', 'post', ['id' => 'issue-574-checker-form']);
                ...
                <div id="table-participante3" style="padding: 0 20px 20px 20px;">
                    ...
                    <div class="row" id="head-table-participante2">
                      <div class="col-xs-4" style="padding: 8px;"><center><strong><?php echo __('Category Identifier'); ?></strong></center></div>
                      <div class="col-xs-4" style="padding: 8px;"><center><strong><?php echo __('Category'); ?></strong></center></div>
                      <div class="col-xs-4" style="padding: 8px;"><center><strong><?php echo __('Action'); ?></strong></center></div>
                    </div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <span class="glyphicon glyphicon-indent-left"></span>
        <h3 class="panel-title" style="display: inline;"><?php echo __('Value by Category Type'); ?></h3>
        <div class="clearfix"></div>
    </div>
    <div id="yw0" class="panel-body">
                ...
                <div id="table-participante2" style="padding: 0 20px 20px 20px;">
                    ...
                    <div class="row" id="head-table-participante2">
                      <div class="col-xs-3" style="padding: 8px;"><center><strong><?php echo __('Category Type'); ?></strong></center></div>
                      <div class="col-xs-4" style="padding: 8px;"><center><strong><?php echo __('Date'); ?></strong></center></div>
                      <div class="col-xs-3" style="padding: 8px;"><center><strong><?php echo __('Value'); ?></strong></center></div>
                      <div class="col-xs-2" style="padding: 8px;"><center><strong><?php echo __('Action'); ?></strong></center></div>
                    </div>
...
//                                         echo $form->datePickerGroup($competenciaTipo, 'fecha', array('widgetOptions' => array('options' => array('format' => 'dd-mm-yyyy'), 'htmlOptions' => array('class' => 'span5', 'name'=>'datepicker_'.$i, 'disabled'=>'disabled')), 'labelOptions' => array('label' => false), 'prepend' => '<i class="glyphicon glyphicon-calendar"></i>')); 
                                    ...
                                    <div class="col-xs-1" style="padding: 8px;">
                                        <?php 
                                            ...
                                            echo $form->dropDownListGroup($competenciaTipo,'dia',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5', 'name'=>'diaPaseCategoria'.$ii),'data'=>array(''=>'Select...')+$data),  'labelOptions'=>array('label'=>false)));
                                        ?>
                                    </div>
                                    <div class="col-xs-1" style="padding: 8px;">
                                        <?php 
                                            ...
                                            echo $form->dropDownListGroup($competenciaTipo,'mes',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5', 'name'=>'mesPaseCategoria'.$ii),'data'=>array(''=>'Select...')+$data),  'labelOptions'=>array('label'=>false)));
                                        ?>
                                    </div>
                                    <div class="col-xs-2" style="padding: 8px;">
                                        <?php 
                                            ...
                                            echo $form->dropDownListGroup($competenciaTipo,'anio',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5', 'name'=>'anioPaseCategoria'.$ii),'data'=>array(''=>__('Select...'))+$data),  'labelOptions'=>array('label'=>false)));
                                        ?>
                                    </div>
...
//        alert("Bail amount ="+montoAfianzar+" maximum amount to bail ="+montoMaximoAfianzar+"\nAs a result, the amount calculated to be secured exceeds the available amount for such operation");
//      }
//    }else{
//        $('#Afianzamiento_monto_fianza').val('0');
//    }
//    deduccionFianza();
//    //}else{
//      //alert('You are trying to secure(afianzar) ')
//    //}
//  }  
