...
<div id="errores2" style=" display: none;" class="row">
    <div class="col-sm-12 col-md-12">
        <div  class="alert alert-danger">
            <label style=" display: block;" id="superacion">You have reach the maximum limit for this category</label>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="alert alert-success">
                    <center>
                        To cancell all the categories, go to: &nbsp;&nbsp;<b><a href="http:<?php echo Yii::app()->baseUrl; ?>/usuario/historial">(Historia->Payments History)</a></b>
                    </center>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12 col-md-12">
                <div style="" id="mensajesCategoria"> 
                    <div id="errores" style=" display: none;" class="alert alert-danger">
                        <label style=" display: none;" id="superacion">You have reach the limit for this category</label>
                        <label style=" display: none;" id="edadFuera">You don't have the required age for this category.</label>
                    </div>
                ...
                <div class="panel-heading">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12 bootstrap-timepicker input-group">
                                    <input onblur='findIdentificacion(this.value)'  onKeyPress='return soloNumeros(event)' style=" width: 100%;" id="usuarioBusqueda" class="form-control" type="text" onblur="" placeholder="Identification Number" name="correoBusqueda" maxlength="30" size="45">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span onclick="" class="glyphicon glyphicon-user" aria-hidden="true"></span>  Data
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div id="table-participante" style="padding: 0 5px 5px 5px;">
                                        <div class="row" id="head-table-participante">
                                          ...
                                          <div class="col-xs-4" style="padding: 5px;"><strong>Identification</strong></div>
                                          <div class="col-xs-2" style="text-align: right; padding: 5px;"><strong>Action</strong></div>
                                        </div>
                                        <?php
                                        $count = 0;
...
<!--                    <div class="form-actions">-->
                            ...
                            if($competencia->gratis != 1){
                                $this->widget('booster.widgets.TbButton', array(
                                    'buttonType'=>'submit',
                                    'context'=>'primary',
                                    'label'=>$model->isNewRecord ? 'Buy' : 'Update',
                                )); 
                            }else{
                                $this->widget('booster.widgets.TbButton', array(
                                    'buttonType'=>'submit',
                                    'context'=>'primary',
                                    'label'=>$model->isNewRecord ? 'Create Category' : 'Update',
                                )); 
                            }    
                            ?>
                    <!--</div>-->
...
<!--                            <div class="row">
                                <div class="col-sm-12 col-md-12">
                                    <div class="alert alert-success">
                                        <center>
                                            To cancell all the categories, go to : &nbsp;&nbsp;<b><a href="http:<?php echo Yii::app()->baseUrl; ?>/usuario/historial">(Historia->Payment History)</a></b>
                                        </center>
                                    </div>
                                </div>
                            </div>-->
                            <!--<a href="http:<?php echo Yii::app()->baseUrl; ?>/usuario/historial">Pay everything</a>-->
                            <?php
                        }
                    }
                    ?>
...
<!--        <div class="row">
            <div  class="col-sm-12 col-md-12">
                <center>
                    ...
                    <a href="../pago/pagoPaypal" class="btn btn-default" href="">Pay</a>
                   Pay everything: &nbsp;&nbsp;<div id="paypal-button-container"></div>
                </center>
            </div>
        </div>-->
        <?php /*
    ...
    <center>
        <a href="http:<?php echo Yii::app()->baseUrl; ?>/usuario/historial">Submit</a>
    </center>
</div>
    ...
    if(categoria){
        if(cantidadP >= 3){
            ...
            if(countRow >= cantidadP){  
                $('#UsuarioEncontrado').html('<div class="alert alert-danger"><b>You reached the limit of allowed participants</b></div>');
            }else{
                var idCategoria = $('#idCategoria').val();
                var idCompetencia = $('#id').val();
                var tipo = $('#tipo').val();  
