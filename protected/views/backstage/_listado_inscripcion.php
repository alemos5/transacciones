...
<span class="ez">Backstage / <?php echo __('Competition');?>: <?php echo $competencia->competencia; ?> / <?php echo __('Category'); ?>: <?php echo $categoria->categoria?>
                                    ...
                                    <?php } ?>    
                                        ...
                                        <td>
                                            ...
                                            <?php
                                                    ...
                                                    <label onclick="guardarOrden(<?php  echo $inscripcion->id_inscripcion; ?>,1,1)" class="input-group-addon btn btn-primary" style="width: 10%;">
                                                        <span onclick="guardarOrden(<?php  echo $inscripcion->id_inscripcion; ?>,1,1)" class="glyphicon  glyphicon-ok" aria-hidden="true"></span>
                                                    </label>    
                                                    <?php
                                            ?>   
                                            </center>
