...
//array('label'=>'Listado final','url'=>array('listadoGeneral?idc=46&idca%20=153')),
...
<span class="ez"><?php echo __('Backstage'); ?></span>
                        ...
                        <table style=" width: 100%;" id="example" class="row-border hover order-column" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <td><center><strong><?php echo __('List'); ?></strong></center></td>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                ...
                                foreach ($competencias as $competencia){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                            <a href="listadoGeneral?idc=<?php echo $competencia->id_copetencia; ?>">
