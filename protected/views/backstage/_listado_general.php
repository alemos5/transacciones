...
<span class="ez"><?php echo __('Backstage / Competition'); ?>: <?php echo $competencia->competencia; ?> / <?php echo __('General Listing'); ?></span>
                        ...
                        <table style=" width: 100%;" id="example" class="table table-hover" cellspacing="0">
                            <thead>
                                <tr>
                                    ...
                                    <td style=" width: 10%;"><center><strong><?php echo __('Play'); ?></strong></center></td>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                foreach ($categorias as $categoria){
                                    $inscripciones = Inscripcion::model()->findAll('id_copetencia ='.$competencia->id_copetencia.' AND id_categoria ='.$categoria->id_categoria.' AND acreditado = 1 and validado = 1 ORDER BY orden ASC');
...
function guardarOrden(id, validado ,todo, id_copetencia, id_categoria ){
    ...
    var valor = $('#ordenCategoria'+id).val();
    var mensaje;
    var opcion = confirm("<?php echo __('Do you really want to validate the indicated order?'); ?>");
    if(valor != ""){
//        alert(valor+' / '+id);
        if (opcion == true) {
