                        ...
                        <table style=" width: 100%;" id="example" class="table table-hover" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                foreach ($categorias as $categoria){
                                    $inscripciones = Inscripcion::model()->findAll('id_copetencia ='.$competencia->id_copetencia.' AND id_categoria ='.$categoria->id_categoria.' AND acreditado = 1 AND musica_validada = 1 ORDER BY orden ASC');
