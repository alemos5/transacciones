...
<span class="ez">Backstage / <?php echo __('Competition'); ?>: <?php echo $competencia->competencia; ?> / <?php echo __('General list'); ?></span>
<div class="pd-inner">
   
        <?php
        
        foreach ($categorias as $categoria){
            $inscripciones = Inscripcion::model()->findAll('id_copetencia ='.$competencia->id_copetencia.' AND id_categoria ='.$categoria->id_categoria.' AND acreditado = 1 AND audio != "audio_defaul.mp3" AND musica_validada = 1 AND reproducida = 0 ORDER BY orden ASC LIMIT 2');
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            //echo $inscripcion->id_categoria.' - '.$inscripcion->id_inscripcion; 
                                                ?>
                                                <video style="width: 100%; height: 60px;" src="<?php echo Yii::app()->request->baseUrl; ?>/images/audio/<?php echo $inscripcion->audio; ?>" controls>
