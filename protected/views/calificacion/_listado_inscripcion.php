...
<span class="ez"> <?php echo __('Order of Qualifications'); ?> / <?php echo __('Competition');?>: <?php echo $competencia->competencia; ?> / <?php echo __('Category'); ?>: <?php echo $categoria->categoria?>
