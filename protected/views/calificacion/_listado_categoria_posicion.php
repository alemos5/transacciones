...
<span class="ez"><?php echo __('Position Table'); ?> / <?php echo __('Competition');?>: <?php echo $competencia->competencia; ?>
...
//                                    if(count($inscripciones) <= $cantidad){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                            <a href="listadoInscripcionPosicion?idc=<?php echo $categoria->id_copetencia; ?>&idca =<?php echo $categoria->id_categoria; ?>">
