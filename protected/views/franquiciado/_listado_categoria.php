...
<span class="ez"><?php echo __('Franchisee: Competition').": ".$competencia->competencia; ?>
                            ...
                            <tbody>
                                ...
                                foreach ($franquiciados as $franquiciado){
                                    if($i == 0){
                                        ...
                                        $orr = " id_copetencia = ".$franquiciado->id_competencia;
                                    }else{
                                        $or .= " OR id_copetencia = ".$franquiciado->id_competencia;
                                        $orr .= " OR id_copetencia = ".$franquiciado->id_competencia;
                                    }
                                    ?>
                                <tr>
