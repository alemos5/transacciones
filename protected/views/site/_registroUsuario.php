    ...
    <div id="RU">     
          ...
          <div class="row">
            <div class="col-md-12">
                ...
                echo $form->dropDownListGroup($usuario,'codigo_pais',array('widgetOptions'=>array('htmlOptions'=>array('class'=>'span5', 'onchange'=>'findCiudad(this.value)'), 'data'=>array(''=>__('Select...'))+$data), 'labelOptions'=>array('label'=>__('Country:')))); ?>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
          ...
          <!--<div class="row">-->
            <!--<div class="col-md-12">-->
                ...
                */
                ...
                ?>
                <?php echo $form->hiddenField($usuario,'tipo_usuario',array('type'=>"hidden", 'value'=>"1")); ?>
            <!--</div>-->
          <!--</div>-->
