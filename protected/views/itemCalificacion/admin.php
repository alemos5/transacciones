...
$this->menu=array(
array('label'=>__('List Item Calification'),'url'=>array('index')),
array('label'=>__('Create Item Calification'),'url'=>array('create')),
);
...
$.fn.yiiGridView.update('item-calificacion-grid', {
data: $(this).serialize()
});
return false;
});
...
<span class="ez"><?php echo __('Manage Item Califications'); ?></span>
