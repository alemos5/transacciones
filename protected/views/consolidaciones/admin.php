...
function imprimir($id_con){
    $imprimir = '<a target="_blank" href="http://tracking.telocomproenusa.com/admin/labelct.php?id='.$id_con.'"><span class="glyphicon glyphicon-print"></span></a>';
