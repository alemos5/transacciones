<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('cost_orden')); ?>:</b>
	<?php echo CHtml::encode($data->cost_orden); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('cliente_manifiesto')); ?>:</b>
	<?php echo CHtml::encode($data->cliente_manifiesto); ?>
	<br />
