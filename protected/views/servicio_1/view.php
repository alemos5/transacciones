            ...
            <table class="table table-bordered table-hover">
                <thead style="">
                    <tr>
                        ...
                        <td style=" width: 10%;"><center><strong>Calculado Por</strong></center></td>
                        <td style=" width: 10%;"><center><strong>Porcentaje</strong></center></td>
                ...
                <tbody>
                    ...
                    foreach ($servicioImpuestos as $servicioImpuesto){
                        $porcentaje += $servicioImpuesto->porcentaje;
                        ...
                        <tr>
                            ...
                            <td style=" width: 10%;"><center><?php echo $servicioImpuesto->idCalculoA->calculo_a; ?></center></td>
                            <td style=" width: 10%;"><center><?php echo $servicioImpuesto->porcentaje; ?></center></td>
                            <td style=" width: 20%;"><center><?php echo $servicioImpuesto->precio_impuesto; ?></center></td>
                        </tr>
                        <?php
                    }
                    ?>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td ><center><strong><?php echo $porcentaje; ?></strong></center></td>
