...
//                                    
                                    ...
                                    if(count($inscripciones) > 8 ){
                                    foreach ($inscripciones as $inscripcion){
                                        Yii::app()->db->createCommand("UPDATE `inscripcion` SET `ronda` = 2 WHERE  id_copetencia = 47 AND  `id_inscripcion` = ".$inscripcion->id_inscripcion." AND ganador = 0;")->query();
                                    }
                                    ?>
                                    <tr>
