                    ...
                    <div class="table-responsive">
                        ...
                        <table style=" width: 100%;" id="example" class="row-border hover order-column" cellspacing="0">
                            ...
                            <tbody>
                                ...
                                $rondas = JuezRonda::model()->findAll('id_juez ='.Yii::app()->user->id_usuario_sistema);
                                foreach ($rondas as $ronda){
                                    ?>
                                    <tr>
                                        <td><center><?php echo $ronda->idRonda->idCompetencia->competencia; ?></center></td>
                                        <td><center><?php echo $ronda->idRonda->ronda; ?></center></td>
                                        <td><center><?php echo $ronda->idRonda->fecha_inicio; ?></center></td>
                                        <td><center><?php echo $ronda->idRonda->fecha_final; ?></center></td>
                                        <td>
                                            <center>
                                                <a href="listadoGeneral?idc=<?php echo $id_competencia; ?>&id_ronda=<?php echo $ronda->id_ronda;?>">
