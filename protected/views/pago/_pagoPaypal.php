...
$this->menu=array(
array('label'=>'Report Payment','url'=>array('create')),
//array('label'=>'Administrar Pagos','url'=>array('admin')),
);
?>
<span class="ez">Payments: Categories</span>
...
<table class="table table-bordered table-hover">
    <thead style=" background-color: #ccc;">
        <tr>
            <td>
                <center><b>Competence</b></center>
            </td>
            <td>
                <center><b>Category</b></center>
            </td>
            <td>
                <center><b>Date of registration</b></center>
            </td>
            <td>
                <center><b>Recorder</b></center>
            </td>
            <td>
