    ...
    array(
        ...
        'items' => array(
            ...
            array(
                ...
                'items' => array(
                    array('label' => '<span class="user-menu glyphicon glyphicon-user"></span>', 'url' => '#','items'=> array(
                                    array('label' => 'Log out','icon'=>'file','url' => array('/site/logout')), 
									)),                
                ),
            ),
        ),
...
<?php echo $content; ?>
    ...
    <?php if(!Yii::app()->user->isGuest):
		echo '<div class="back"  id="footer">				
				...
				<p><a href="'.Yii::app()->request->baseUrl.'/site/construccio">Use terms</a> > <a href="'.Yii::app()->request->baseUrl.'/site/construccio">About us</a> > <a href="'.Yii::app()->request->baseUrl.'/site/construccio">Privacy policies</a></p>
			  </div>'; else: 
		echo '<div  id="footer">
				<hr class="soften">
