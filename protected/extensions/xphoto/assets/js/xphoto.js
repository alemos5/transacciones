...
var XPhoto = XPhotoClass({
    ...
    createButtons: function(){
    	var buttons = '';
    	if(this.options.capture===true){
    		buttons += '<button type="button" class="btn btn-success xphoto-button-camera"><i class="fa fa-camera"></i><span class="glyphicon glyphicon-camera"></span>&nbsp;&nbsp;Tomar Foto</button>'
					  +'<button type="button" class="btn btn-primary xphoto-button-snap" style="display:none;"><i class="fa fa-circle"></i></button>';
		}
		if(this.options.upload===true){
			buttons += '<button type="button" class="btn btn-default xphoto-button-upload"><i class="fa fa-upload"></i><span class="glyphicon glyphicon-picture"></span>&nbsp;&nbsp;Subir Imagen</button>';
		}
					    ...
					    +'<div class="modal-content">'
					      ...
					      +'<div class="modal-body">'
					        ...
					        +'<div class="xphoto-modal-buttons">'
					        	+'<button type="button" class="xphoto-modal-button-snap btn btn-primary btn-lg"><i class="fa fa-circle"></i><span class="glyphicon glyphicon-camera"></span></button>'					        	
					        +'</div>'	
					      +'</div>'
					    +'</div>'
					  +'</div>'
