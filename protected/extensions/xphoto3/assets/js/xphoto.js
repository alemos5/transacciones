...
var XPhoto = XPhotoClass({
    ...
    createButtons: function(){
		...
		if(this.options.upload===true){
			buttons += '<button type="button" class="btn btn-default xphoto-button-upload"><i class="fa fa-upload"></i> Subir imágen</button>';
		}
					    ...
					    +'<div class="modal-content">'
					      ...
					      +'<div class="modal-body">'
					        ...
					        +'<div class="xphoto-modal-buttons">'
					        	+'<button type="button" class="xphoto-modal-button-snap btn btn-primary btn-lg"><i class="fa fa-circle">Capturar</i></button>'					        	
					        +'</div>'	
					      +'</div>'
					    +'</div>'
					  +'</div>'
