...
'actions'=>array('create','update', 'listadoCompetencia', 'listadoCategoria' , 'listadoPago', 'listadoPagoPase'),
'users'=>array('@'),
),
...
public function actionlistadoPagoPase(){
    $this->render('_listado_pase_competidor',array(
//        'model'=>$model,
    ));
}
...
//    $inscripciones = Inscripcion::model()->findAll();
    $participantes = Participante::model()->findAll();
...
public function actionlistadoCategoria()
{
    ...
    $competenciaCategorias =  CompetenciaCategoria::model()->findAll('id_copetencia = 47');
...
public function actionlistadoPago()
{
    ...
    $competenciaCategorias =  CompetenciaCategoria::model()->findAll();
    $this->render('_listado_pago',array(
        'competenciaCategorias'=>$competenciaCategorias,
    ));
}
