...
class MunicipioController extends Controller
{
  ...
  public function accessRules()
  {
    return array(
      ...
      array('allow', // allow authenticated user to perform 'create' and 'update' actions
        'actions'=>array('create','update', 'findMunicipio'),
        'users'=>array('@'),
      ),
  ...
  */
  ...
  public function actionFindMunicipio()
  {
    if($_POST['id_estado'])
    {
      $model=Municipio::model()->findAll('id_estado=:id_estado ORDER BY nombre', array(':id_estado'=>$_POST['id_estado']));
