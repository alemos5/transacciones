...
class ParroquiaController extends Controller
{
  ...
  public function accessRules()
  {
    return array(
      ...
      array('allow', // allow authenticated user to perform 'create' and 'update' actions
        'actions'=>array('create','update', 'findParroquia'),
        'users'=>array('@'),
      ),
  ...
  */
  ...
  public function actionFindParroquia()
  {
    if($_POST['id_municipio'])
    {
      $model=Parroquia::model()->findAll('id_municipio=:id_municipio ORDER BY nombre', array(':id_municipio'=>$_POST['id_municipio']));
      echo "<option value=\"\">Seleccione...</option>";
      foreach($model as $municipio)
      {
        echo "<option value=\"".$municipio->id_parroquia."\">".$municipio->nombre."</option>";
      }
    }
