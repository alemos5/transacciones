...
'actions'=>array('create','update', 'listadoGeneral'),
'users'=>array('@'),
),
...
{
$dataProvider=new CActiveDataProvider('Soporte');
$this->render('index',array(
'dataProvider'=>$dataProvider,
));
}
public function actionListadoGeneral($id_usuario = NULL)
{
...
{
$model=Soporte::model()->findByPk($id);
if($model===null)
