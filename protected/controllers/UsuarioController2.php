...
//                die('aqui1');
  ...
  public function actionRegistarUsuario() {
      //die("Aqui");
      Yii::app()->user->id_usuario_sistema = 1;
      //session_start();
    ...
    if($model->save()){
        ...
        $message->subject = __('WIN account activation  - Online Competition System');
	...
	<tbody>
		...
		<tr>
			...
			<p style="margin-bottom: 0cm; line-height: 100%; text-align: center;"> 
                        '.__('We are glad to have you here. Welcome to our WIN - Online Competition System').'
                        <br>
			...
			<p style="margin-bottom: 0cm; line-height: 100%; text-align: center;">
                       	<br><a class="btn" href="http://www.appwin.net/usuario/activarUsuario?i='.$usuario.'">'.__('Activate user').'</a>
                        </p>
			</td>
		</tr>
		<tr><td>&nbsp;</td></tr>
...
<p>&nbsp;</p>
        ...
        <div id="" style="" class="alert alert-success">
            <b><?php echo __('We have sent you an email to activate your account.'); ?></b>
            <hr>
        </div>
        <?php
    }else{
