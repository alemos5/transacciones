    ...
    public function accessRules()
    {
        return array(
            array('allow',  // allow all users to perform 'index' and 'view' actions
                'actions' => array('index', 'view','FindCiudad'),
                'users' => array('*'),
            ),
...
// if AJAX request (triggered by deletion via admin grid view), we should not redirect the browser
    ...
    public function actionFindCiudad()
    {
        ////session_start();
        ...
        if($_POST['pais'])
        {
            //$model=Ciudad::model()->findAll('codigo_pais=:codigo_pais ORDER BY ciudad', array(':codigo_pais'=>$_POST['pais']));
            $model=Ciudad::model()->findAll('id_pais='.$_POST['pais']);
        ...
        else echo '<option value="">'.__('Select...').'</option>';
        Yii::app()->end();
    }
