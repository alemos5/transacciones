...
'actions'=>array('create','update', 'findServicio'),
'users'=>array('@'),
),
...
public function actionFindServicio()
  {
    if($_POST['id_empresa'])
    {
      $model= Servicio::model()->findAll('id_empresa=:id_empresa ORDER BY servicio', array(':id_empresa'=>$_POST['id_empresa']));
      echo "<option value=\"\">Seleccione...</option>";
      foreach($model as $servicio)
      {
