...
{
$dataProvider=new CActiveDataProvider('TarifaProducto');
...
{
$model=new TarifaProducto('search');
$model->unsetAttributes();  // clear any default values
if(isset($_GET['TarifaProducto']))
$model->attributes=$_GET['TarifaProducto'];
...
{
$model=TarifaProducto::model()->findByPk($id);
if($model===null)
...
{
if(isset($_POST['ajax']) && $_POST['ajax']==='tarifa-producto-form')
{
