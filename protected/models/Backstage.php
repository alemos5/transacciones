...
/**
 * This is the model class for table "backstage".
 *
 * The followings are the available columns in table 'backstage':
 * @property integer $id_backstage
 * @property string $backstage
 * @property integer $estatus
 */
class Backstage extends CActiveRecord
{
...
//    }
	...
	public function rules()
	{
		...
		return array(
			array('backstage', 'required'),
			array('estatus', 'numerical', 'integerOnly'=>true),
			array('backstage', 'length', 'max'=>250),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_backstage, backstage, estatus', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_backstage',$this->id_backstage);
		$criteria->compare('backstage',$this->backstage,true);
	 ...
	 * @return Backstage the static model class
	 */
