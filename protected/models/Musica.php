...
class Musica extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('musica', 'required'),
			array('estatus', 'numerical', 'integerOnly'=>true),
			array('musica', 'length', 'max'=>250),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_musica, musica, estatus', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_musica',$this->id_musica);
		$criteria->compare('musica',$this->musica,true);
