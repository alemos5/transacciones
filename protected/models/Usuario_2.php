...
//		);
			...
			array('rif, fecha_registro, latitud, longitud', 'safe'),
                        ...
                        array('usuario', 'unique', 'message'=>'User already exist'),
                        array('correo', 'unique', 'message'=>'Email already exist'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'sexo' => 'Gender',
			'observacion_personal' => 'Observation',
			'a_r' => 'A R',
			'n_j' => 'N J',
			'razon_social' => 'Razon Social',
			'tlf_habitacion' => 'Room phone',
			'tlf_personal' => 'Phone',
			'tlf_personal2' => 'Phone 2',
			'correo' => 'Email',
			'correo2' => 'Repeat Email',
			'autorizacion' => 'Athorization',
			'img' => 'Img',
			'usuario' => 'User',
			'contrasena' => 'Password',
			'id_perfil_sistema' => 'Id system profile',
			'fecha_registro' => 'Register date',
			'estatus' => 'Status',
			'estatus_contrasena' => 'Password Status',
			'direccion_ip' => 'Ip Address',
			'id_registrador' => 'Id Recorder',
			'id_sociedad' => 'Id Society',
		);
	}
