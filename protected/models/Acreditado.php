...
/**
 * This is the model class for table "acreditado".
 *
 * The followings are the available columns in table 'acreditado':
 * @property integer $id_acreditado
 * @property string $acreditado
 * @property integer $estatus
 */
class Acreditado extends CActiveRecord
{
...
//    }
	...
	public function rules()
	{
		...
		return array(
			array('acreditado', 'required'),
			array('estatus', 'numerical', 'integerOnly'=>true),
			array('acreditado', 'length', 'max'=>250),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_acreditado, acreditado, estatus', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('id_acreditado',$this->id_acreditado);
	 ...
	 * @return Acreditado the static model class
	 */
