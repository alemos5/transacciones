...
class FormaPago extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('forma_pago', 'length', 'max'=>250),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_forma_pago, forma_pago, estatus', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'pagos' => array(self::HAS_MANY, 'Pago', 'id_forma_pago'),
		);
	}
	...
	{
		return array(
			'id_forma_pago' => 'Id Payment method',
