...
/**
 * This is the model class for table "franquiciado_desembolso".
 *
 * The followings are the available columns in table 'franquiciado_desembolso':
 ...
 */
class FranquiciadoDesembolso extends CActiveRecord
{
...
//                    'FranquiciadoDesembolso' => 'id_franquiciado_desembolso',
//                ),
//
...
//    }
	...
	{
		return 'franquiciado_desembolso';
	}
	...
	public function rules()
	{
		...
		return array(
			array('id_competencia, monto, id_franquiciado, fecha_registro, id_usuario', 'required'),
			array('id_competencia, id_franquiciado, id_usuario, estatus', 'numerical', 'integerOnly'=>true),
			array('monto', 'length', 'max'=>10),
			array('descripcion', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_franquiciado_desembolso, id_competencia, id_franquiciado, descripcion, fecha_registro, id_usuario, monto, estatus', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
                    ...
                    'idUsuario' => array(self::BELONGS_TO, 'Usuario', 'id_franquiciado'),
		);
	}
	 ...
	 * @return FranquiciadoDesembolso the static model class
	 */
