...
class Inscripcion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('ganador, ronda, error, calificacion, reproducida, musica_validada, orden, validado, acreditado, id_copetencia, id_categoria, id_competencia_tipo, id_usuario, id_ciudad, id_escuela, id_escuela, id_estatu_inscripcion', 'numerical', 'integerOnly'=>true),
			array('grupo, lugar_representa, ciudad, fecha_inscripcion', 'length', 'max'=>250),
			array('costo', 'length', 'max'=>10),
                        array('calificacion_final', 'length', 'max'=>10),
                        array('codigo_pais', 'length', 'max'=>5),
                        array('qr', 'length', 'max'=>250),
			array('descripcion', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ganador, ronda, calificacion_final, error, calificacion, reproducida, musica_validada, orden, validado, id_inscripcion, costo, id_copetencia, id_competencia_tipo, id_usuario, grupo, descripcion, audio, lugar_representa, codigo_pais, id_ciudad, id_escuela, id_estatu_inscripcion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'idPais' => array(self::BELONGS_TO, 'Pais', 'codigo_pais'),
                        ...
                        'idRonda' => array(self::BELONGS_TO, 'OrganizacionRonda', 'ronda'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'qr' => __('QR'),
                        ...
                        'error' => __('Error'),
                        'calificacion_final' => __('Final score'),
                        'ronda' => __('Round'),
                        'ganador' => __('Ganador'),
		);
	}
