...
class Calificacion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_categoria_item_calificacion', 'required'),
			array('id_categoria_item_calificacion', 'numerical', 'integerOnly'=>true),
			array('rango_max, rango_min', 'length', 'max'=>2),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_calificacion, id_categoria_item_calificacion, rango_max, rango_min', 'safe', 'on'=>'search'),
		);
	}
