...
class Inscripcion extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_copetencia, id_competencia_tipo, id_usuario, fecha_inscripcion, lugar_representa, codigo_pais, id_ciudad,  id_estatu_inscripcion', 'required'),
			array('id_copetencia, id_categoria, id_competencia_tipo, id_usuario, id_ciudad, id_escuela, id_escuela, id_estatu_inscripcion', 'numerical', 'integerOnly'=>true),
			...
			array('id_inscripcion, costo, id_copetencia, id_competencia_tipo, id_usuario, grupo, descripcion, audio, lugar_representa, codigo_pais, id_ciudad, id_escuela, id_estatu_inscripcion', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'id_competencia_tipo' => 'Id Competencia Tipo',
			'id_categoria' => 'Id Categoria',
			'id_usuario' => 'Id Usuario',
			'grupo' => 'Grupo',
			'descripcion' => 'Descripcion',
			'audio' => 'Audio',
			'lugar_representa' => 'Lugar Representa',
